...
class CBF_RRT:
    def __init__(self, obstacle_list):
        ...
        self.cbf_constraints_sensing_radius = 500
        # self.k_cbf = 2.0
        self.k_cbf = 80.0  # CBF coefficient for double intergrators
        #   # CBF coefficient for double intergrators
        # self.k_cbf2 = (
        #     1.0  # CBF coefficient for double intergrators, If acceleration is used
        # )
        self.k_cbf2 = 3.0  # CBF coefficient for double intergrators, If acceleration is used
...
if __name__ == "__main__":
    ...
    x, u = CBFRRT_Planning.motion_planning_with_QP(
